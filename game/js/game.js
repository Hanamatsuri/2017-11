		...
		var ballMaterial = new THREE.MeshPhongMaterial( { color: 0x111111 } );
		...
		function animate() {
			...
			$("#itemnum").html(rigidBodies.length);
			$("#time").html(time.toFixed(2));
			$("#itemspd").html(spd);
			$("#atk").html(fractureImpulse);
			
			localStorage.defen=rigidBodies.length;
        ...
        var spd=100;
        // 断裂所需冲击
        var fractureImpulse = 400;
        
		function updatePhysics( deltaTime ) {

			// 物件速度
			physicsWorld.stepSimulation( deltaTime, spd );
